              ...
              <div className="card-premium p-8 flex flex-col gap-8 bg-white shadow-2xl shadow-slate-200/50">
                 ...
                 <div className="pt-6 border-t border-slate-100 flex flex-col gap-4">
                    ...
                    <button
                      ...
                      className="w-full py-5 bg-[#F8FBF8] text-[#0F1C12] rounded-2xl font-black text-xs uppercase tracking-[0.2em] hover:bg-primary-600 hover:shadow-xl hover:shadow-primary-500/20 transition-all flex items-center justify-center gap-3 group active:scale-95 disabled:opacity-50 disabled:pointer-events-none"
                    >
                      {loading ? (
                        <div className="flex items-center gap-3">
               ...
               >
                  ...
                  <div className="card-premium bg-white p-8 md:p-10 shadow-2xl shadow-slate-200/50 flex flex-col gap-8 border border-slate-100">
                     <div className="flex items-center justify-between border-b border-slate-100 pb-6">
                        <div className="flex items-center gap-3">
                           <div className="bg-[#F8FBF8] p-2 rounded-xl text-[#0F1C12]">
                              <FileText size={18} />
                           </div>
